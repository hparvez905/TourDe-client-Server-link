    ...
    return (
        <div className="container">
            ...
            <section className="d-flex justify-content-between  ">
                <img className="w-50 img-fluid" src="https://go.carolinas.aaa.com/wp-content/uploads/2020/11/TravelWithKids_Covid_19_748.jpg" alt="" />

                <p> <h3>Who are we?</h3>
                     TourDe  is the country’s first and leading online travel aggregator. Initially started with the name Travel Booking BD, we had a dream to make travel easier for people. And that is what we did since our inception. And now with our new, innovative, easy to use app, travel services are on your palm. The dynamic app lets you book your flight, find your perfect holiday from our thousands of holiday packages around the globe.
                    <br />


                    Comfort Tour is revolutionizing the way we book travel services. With Comfort Tour’s website and mobile app, booking your flight, hotel or holiday become more fun that you would think. With exciting games and real rewards like free trips and air ticket makes Comfort Tour more fun to use! You can also win TripCoin by playing games and booking service from Comfort Tour, that you can use to avail discount.
                    <br />
